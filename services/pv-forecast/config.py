...
class PVForecastSettings(BaseSettings):
    # --- PV Array: East ---
    pv_east_energy_entity_id: str = ""  # e.g. sensor.pv_east_energy_daily (kWh today)
    ...
    # --- PV Array: West ---
    pv_west_energy_entity_id: str = ""  # e.g. sensor.pv_west_energy_daily (kWh today)
    ...
    forecast_solar_east_entity_id: str = ""  # e.g. sensor.energy_production_east_today
    forecast_solar_west_entity_id: str = ""  # e.g. sensor.energy_production_west_today
